  ...
  <main>
    <div class="calc">
      ...
      <div class="valores-forms">
        <label for="input-valor">Valor da conta</label>
        <input v-model="valor" placeholder="0" id="input-valor" type="number" />
      </div>
      <div class="valores-forms">
        <label for="select-servico">Qualidade do serviço?</label>
        <select
      ...
      <div class="valores-forms">
        <label for="input-pessoas"
          >Quantas pessoas estão pagando?</label
        >
        <input
          v-model="pessoa"
          placeholder="1"
    ...
    <div class="resultado">
      <h2>Valor:</h2>
      <span>R$ {{ valor_final }} <strong>por pessoa</strong></span>
    </div>
  </main>
</template>
